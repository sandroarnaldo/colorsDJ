...
import 'package:colorsdj/pages/edit_profile.dart';
...
import 'package:colorsdj/widgets/post_tile.dart';
      ...
      child: FlatButton(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isFollowing ? Colors.white : Colors.orange[900],
            border: Border.all(
    ...
    return Row(
      ...
      children: <Widget>[
        IconButton(
            ...
            icon: Icon(Icons.view_module, size: 35.0),
            color: postOrientation == 'grid'
                ? Colors.orange[900]
                : Colors.black87),
        IconButton(
          onPressed: () => setPostOrientation("list"),
          icon: Icon(Icons.line_weight, size: 35.0),
          color:
              postOrientation == 'list' ? Colors.orange[900] : Colors.black87,
        ),
      ],
    );
  }
