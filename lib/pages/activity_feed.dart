...
import 'package:colorsdj/pages/post_screen.dart';
      ...
      child: Container(
        ...
        child: ListTile(
          title: GestureDetector(
            onTap: () =>
                showProfile(context, profileId: userId, song_url: songRef),
            child: RichText(
...
showProfile(BuildContext context, {String profileId, @required song_url}) {
  Navigator.push(
    context,
    MaterialPageRoute(
